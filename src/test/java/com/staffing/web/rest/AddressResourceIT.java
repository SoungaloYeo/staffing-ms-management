...
class AddressResourceIT {
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().address1(DEFAULT_ADDRESS_1).address2(DEFAULT_ADDRESS_2).city(DEFAULT_CITY).country(DEFAULT_COUNTRY);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().address1(UPDATED_ADDRESS_1).address2(UPDATED_ADDRESS_2).city(UPDATED_CITY).country(UPDATED_COUNTRY);
        return address;
    }
    ...
    void putExistingAddress() throws Exception {
        ...
        updatedAddress.address1(UPDATED_ADDRESS_1).address2(UPDATED_ADDRESS_2).city(UPDATED_CITY).country(UPDATED_COUNTRY);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.address2(UPDATED_ADDRESS_2).city(UPDATED_CITY).country(UPDATED_COUNTRY);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.address1(UPDATED_ADDRESS_1).address2(UPDATED_ADDRESS_2).city(UPDATED_CITY).country(UPDATED_COUNTRY);
