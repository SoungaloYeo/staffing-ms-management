...
import com.staffing.repository.AddressRepository;
import com.staffing.service.AddressService;
...
/**
 * REST controller for managing {@link com.staffing.domain.Address}.
 */
@RestController
@RequestMapping("/api")
public class AddressResource {
    ...
    private static final String ENTITY_NAME = "staffingMsManagementAddress";
    ...
    public ResponseEntity<List<AddressDTO>> getAllAddresses(
        ...
        Page<AddressDTO> page;
        if (eagerload) {
            page = addressService.findAllWithEagerRelationships(pageable);
        } else {
